    ...
    <>
      <div className="min-h-screen bg-gradient-to-b from-[#d6dbdc] to-white text-black p-24">
        ...
        <div>
          ...
          <p className="text-left text-base mt-7 mb-6">{tosatisfyourgoaltext}</p>
      ...
      <p className="text-left text-sm sm:text-base md:text-lg font-light">
        ...
        {pictureBlock && (
          ...
          <div className="relative ">
            ...
            <img src={pictureBlock.picture.mediaItemUrl} alt="Block Image" className="w-full relative" style={{ zIndex: 0 }} />
          </div>
          </div>
        )}
